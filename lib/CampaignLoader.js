 ...
 *
 * @param {Object} app Parent express application. Cannot be null.
 ...
 * @constructor
 */
module.exports = function CampaignLoader(app, config) {
  ...
  // Constructor
  (function __init() {
    var configurer = new AppConfigurer(campaignApp, extend(config, {
      dataSource: app.get("dataSource"),
      domain: extend({}, app.get("domain"), config.domain),
