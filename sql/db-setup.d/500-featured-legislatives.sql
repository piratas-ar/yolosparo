insert into featured_legislatives (legislative_id, tweet_text, email_text,
  friendly_name)
  values ((select id from legislatives where user_name = 'asanmartin'),
...
insert into featured_legislatives (legislative_id, tweet_text, email_text,
  friendly_name)
  values ((select id from legislatives where user_name = 'acomelli'),
...
insert into featured_legislatives (legislative_id, tweet_text, email_text,
  friendly_name)
  values ((select id from legislatives where user_name = 'mvillarm'),
...
insert into featured_legislatives (legislative_id, tweet_text, email_text,
  friendly_name)
  values ((select id from legislatives where user_name = 'rpucheta'),
...
insert into featured_legislatives (legislative_id, tweet_text, email_text,
  friendly_name)
  values ((select id from legislatives where user_name = 'gfernandezm'),
...
insert into featured_legislatives (legislative_id, tweet_text, email_text,
  friendly_name)
  values ((select id from legislatives where user_name = 'malonso'),
